...
public class ChurchToolsSyncServiceTests : DatabaseTestBase
{
    ...
    public async Task TestIntialSync()
    {
        ...
        var expectedGroupTypes = new Korga.ChurchTools.Entities.GroupType[]
        {
            new(1, "Kleingruppe"),
            new(2, "Dienst"),
        };
        var expectedGroupRoles = new Korga.ChurchTools.Entities.GroupRole[]
        {
        ...
        churchTools.PersonMasterdata.Roles = new PersonMasterdata.Role[]
        {
        ...
        churchTools.PersonMasterdata.GroupTypes = new PersonMasterdata.GroupType[]
        {
            new(1, "Kleingruppe", 0),
            new(2, "Dienst", 0)
        };
    ...
    private async ValueTask InitializeSampleDataset()
    {
        ...
        databaseContext.GroupTypes.AddRange(new Korga.ChurchTools.Entities.GroupType[]
        {
            new(1, "Kleingruppe"),
            new(2, "Dienst"),
        });
        databaseContext.GroupRoles.AddRange(new Korga.ChurchTools.Entities.GroupRole[]
        {
            new(8, 1, "Teilnehmer"),
            new(9, 1, "Leiter"),
    ...
    private class FakeChurchToolsApi : IChurchToolsApi
    {
        ...
        public List<GroupMember> GroupMembers { get; } = new List<GroupMember>();
